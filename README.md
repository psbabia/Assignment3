...
It handles the base case (n == 0 or 1) by returning 1.</br>

For other values, it calls itself with n-1 and multiplies.</br>
...
Sine (assuming the number is in radians)</br>

Finally, it prints the results clearly.</br>
